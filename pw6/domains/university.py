...
class University(object):
    ...
    def input_student(self, stdscr):
        ...
        for student in self.students:
            student_data = {"Student id" : student.id,"Name" : student.name,"Date of birth" : student.dob}
            self.write_to_file("students.pkl", student_data)
    ...
    def input_course(self, stdscr):
        ...
        for course in self.courses:
            course_data = {"Course id" : course.id,"Name" : course.name,"Credit" : course.credit}
            self.write_to_file("courses.pkl", course_data)
    ...
    def input_mark(self, stdscr):
        ...
        for mark in self.marks:
            mark_data = {"Student id" : mark.get_student_id(),"Course id" : mark.get_course_id(),"Mark" : mark.get_mark()}
            self.write_to_file("marks.pkl", mark_data)
